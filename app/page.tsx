...
export default function Home() {
  return (
    <div className="min-h-screen bg-white">
      {/* Header */}
      <header className="sticky top-0 z-50 bg-[#1a1a1a] text-white px-6 md:px-12 py-6 flex items-center justify-between shadow-lg">
        <div className="text-2xl md:text-3xl font-semibold">Robinson&apos;s Redesigns</div>
        <Navigation />
      </header>
      ...
      {/* About Section */}
      <section id="about" className="py-20 px-6 md:px-12 bg-gradient-to-br from-gray-50 to-gray-100">
        <div className="max-w-6xl mx-auto">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-lg text-gray-700 mb-6">
                Every project is approached with care and precision, ensuring that your vision becomes reality while maintaining the highest standards of quality and safety.
              </p>
            ...
            <div className="bg-gradient-to-br from-[#ff6b35] to-[#ff006e] p-12 rounded-lg text-white">
              ...
              <p className="text-lg mb-6">
                To transform spaces and enhance lives through exceptional remodeling services that combine innovative design, superior craftsmanship, and unwavering commitment to customer satisfaction.
              </p>
      ...
      <section id="pricing" className="py-20 px-6 md:px-12 bg-white">
        <div className="max-w-6xl mx-auto">
          ...
          <p className="text-center text-gray-600 mt-8">
            All prices are estimates. Contact us for a detailed quote tailored to your specific project needs.
          </p>
        </div>
      </section>

      {/* Contact Section */}
      <section id="contact" className="py-20 px-6 md:px-12 bg-gradient-to-r from-[#1a1a1a] to-[#2d2d2d] text-white">
        <div className="max-w-6xl mx-auto">
              ...
              <div className="space-y-6">
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <div className="text-gray-300">Mon-Fri: 8:00 AM - 6:00 PM<br />Sat: 9:00 AM - 4:00 PM</div>
                  </div>
                </div>
                <div className="flex items-start">
                  <div className="w-12 h-12 bg-gradient-to-br from-[#ff6b35] to-[#ff006e] rounded-lg flex items-center justify-center mr-4 flex-shrink-0">
              ...
              <form className="space-y-4">
                <div>
                  <input
                    ...
                    className="w-full px-4 py-3 rounded-lg bg-gray-800 text-white placeholder-gray-400 border border-gray-700 focus:outline-none focus:border-[#ff6b35] transition-colors"
                  />
                </div>
                <div>
                  <input
                ...
                <button
                  type="submit"
                  className="w-full bg-gradient-to-r from-[#ff6b35] to-[#ff006e] text-white py-3 rounded-lg font-medium hover:opacity-90 transition-opacity"
                >
                  Send Message
                </button>
              </form>
      ...
      <footer className="bg-[#1a1a1a] text-white py-8 px-6 md:px-12">
        <div className="max-w-6xl mx-auto flex flex-col md:flex-row justify-between items-center">
          <div className="mb-4 md:mb-0">
            <div className="text-xl font-semibold mb-2">Robinson&apos;s Redesigns</div>
            <div className="text-gray-400 text-sm">© 2024 All rights reserved.</div>
          </div>
          <div className="flex gap-6">
            <a href="#" className="text-gray-400 hover:text-[#ff6b35] transition-colors">Privacy Policy</a>
            <a href="#" className="text-gray-400 hover:text-[#ff6b35] transition-colors">Terms of Service</a>
          </div>
        </div>
      </footer>
    </div>
